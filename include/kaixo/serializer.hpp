...
namespace kaixo {
    ...
    namespace detail {
        ...
        template<class Ty> concept can_range = std::ranges::range<Ty> && concepts::default_constructible<Ty>;
    ...
    public:
        ...
        template<class Ty> requires concepts::trivially_copyable<Ty>
        Ty get_direct() {
    ...
    public:
        ...
        constexpr Ty read() {
            ...
            if constexpr (CanPop) { // Can directly read from pointer
